...
#define TEXTMAX 10
  ...
  public:
    ...
    ~Obvious2D();
       ...
       */
      void
      setBorder(unsigned int pixelsLeft, unsigned int pixelsRight, unsigned int pixelsTop, unsigned int pixelsBottom);
     ...
     */
    void registerKeyboardCallback(char key, fptrKeyboardCallback callback, std::string helpText, unsigned char rgba[4],
                                  unsigned char rgbaBG[4]);
       ...
       * @param callback pointer to callback function
       */
      void registerKeyboardClient(const char key, Obvious2DClient *client, std::string helpText, unsigned char rgba[4],
                                  unsigned char rgbaBG[4]);
       ...
       */
      void
      addCrosshair(unsigned int x, unsigned int y, const char *text, unsigned char rgba[4], unsigned char rgbaBG[4],
                   float radius = 0.04f, float offset = 0.0f);
       ...
       */
      void addVolatileInfoText(const char *text, unsigned char rgba[4] = NULL, unsigned char rgbaBG[4] = NULL,
                               double progress = 0.0, bool popup = false);
