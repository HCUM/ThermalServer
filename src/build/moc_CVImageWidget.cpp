...
QT_MOC_LITERAL(5, 38, 9), // "showImage"
QT_MOC_LITERAL(6, 48, 7), // "cv::Mat"
QT_MOC_LITERAL(7, 56, 5) // "image"

    },
    "CVImageWidget\0valueChanged\0\0start\0end\0"
...
void CVImageWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->valueChanged((*reinterpret_cast< QPoint(*)>(_a[1])),(*reinterpret_cast< QPoint(*)>(_a[2]))); break;
        case 1: _t->showImage((*reinterpret_cast< const cv::Mat(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (CVImageWidget::*_t)(QPoint , QPoint );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CVImageWidget::valueChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CVImageWidget::valueChanged(QPoint _t1, QPoint _t2)
{
